...
<?
		...
		<div id="bx-soa-order" class="order__content" style="opacity: 0">
            <!--	AUTH BLOCK	-->
            <div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
                <div class="bx-soa-section-title-container title-block profile__title order__title">
            ...
            <? if ($arParams['BASKET_POSITION'] === 'before'):?>
                <!--	BASKET ITEMS BLOCK	-->
                <div id="bx-soa-basket" data-visited="false" class="order__block bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                        <?=$arParams['MESS_BASKET_BLOCK_NAME']?>
                        <?/*<a href="javascript:void(0)" class="bx-soa-editstep link"><?=$arParams['MESS_EDIT']?></a>*/?>
                    </div>
                    <div class="bx-soa-section-content container-fluid"></div>
                </div>
            <? endif?>
            ...
            <!--	REGION BLOCK	-->
            <div id="bx-soa-region" data-visited="false" class="order__block bx-soa-section bx-active">
                <div class="bx-soa-section-title-container title-block profile__title order__title">
                    <?=$arParams['MESS_REGION_BLOCK_NAME']?>
                    <a href="" class="bx-soa-editstep btn btn--grey btn--m"><?=$arParams['MESS_EDIT']?></a>
                </div>
                <div class="bx-soa-section-content container-fluid"></div>
            </div>
            ...
            <? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
                <!--	PAY SYSTEMS BLOCK	-->
                <div id="bx-soa-paysystem" data-visited="false" class="order__block bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                ...
                <!--	DELIVERY BLOCK	-->
                <div id="bx-soa-delivery" data-visited="false" class="order__block bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                ...
                <!--	PICKUP BLOCK	-->
                <div id="bx-soa-pickup" data-visited="false" class="order__block bx-soa-section" style="display:none">
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                        <?/*<a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a>*/?>
                    </div>
                    <div class="bx-soa-section-content container-fluid"></div>
            ...
            ?>
                <!--	DELIVERY BLOCK	-->
                <div id="bx-soa-delivery" data-visited="false" class="gray-border-top order__block bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                        <?=$arParams['MESS_DELIVERY_BLOCK_NAME']?>
                        <a href="" class="bx-soa-editstep btn btn--grey btn--m"><?=$arParams['MESS_EDIT']?></a>
                    </div>
                ...
                <!--	PAY SYSTEMS BLOCK	-->
                <div id="bx-soa-paysystem" data-visited="false" class="gray-border-top order__block bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container title-block profile__title order__title">
                        <?=$arParams['MESS_PAYMENT_BLOCK_NAME']?>
                        <a href="" class="bx-soa-editstep btn btn--grey btn--m"><?=$arParams['MESS_EDIT']?></a>
                    </div>
            ...
            ?>
            <!--	BUYER PROPS BLOCK	-->
            <div id="bx-soa-properties" data-visited="false" class="gray-border-top order__block bx-soa-section bx-active">
                <div class="bx-soa-section-title-container title-block profile__title order__title">
        ...
        <!--	SIDEBAR BLOCK	-->
        <div id="bx-soa-total" class="aside-box bx-soa-sidebar">
            <h2 class="section-title"><?=GetMessage('SOA_YOUR_ORDER')?></h2>
            <div class="bx-soa-cart-total-ghost"></div>
            <ul class="bx-soa-cart-total aside-box__list"></ul>
            <?/*<a herf="javascript:void(0)" class="btn btn--red btn--icn btn--l order-btn btn-order-save">
