...
$MESS["SOA_PICKUP_PAYMENT"] = "Оплата";
$MESS["SOA_PICKUP_PAYMENT_VALUE"] = "карта, наличные";
$MESS["SOA_PICKUP_DELIVERY"] = "Самовывоз";
$MESS["SOA_PICKUP_DELIVERY_VALUE"] = "Бесплатно / Сегодня";
...
$MESS["SUCCESS_PRELOAD_TEXT_DEFAULT"] = "Вы заказывали в нашем интернет-магазине, поэтому мы заполнили все данные автоматически.
Если все заполнено верно, нажмите кнопку \"#ORDER_BUTTON#\".";
$MESS["FAIL_PRELOAD_TEXT_DEFAULT"] = "Вы заказывали в нашем интернет-магазине, поэтому мы заполнили все данные автоматически.
...
$MESS["EMPTY_BASKET_HINT"] = "Чтобы оформить заказ сначала нужно #A1#добавить товары#A2# в корзину.";
...
$MESS['ORDER_TABLE_PRICE']  = 'Цена';
$MESS['ORDER_TABLE_QTY']    = 'Кол-во';
$MESS['ORDER_TABLE_SUM']    = 'Сумма';
$MESS['SOA_YOUR_ORDER']     = 'Ваш заказ';
$MESS['SOA_ADDRESS_BLOCK']  = 'Адрес доставки';
$MESS['SOA_FREE_TITLE']     = 'беcплатно';
$MESS['SOA_PICKUP_ON_THE_MAP']  = 'Посмотреть на карте';
?>
